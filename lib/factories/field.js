...
function field(WrappedComponent) {
    var WC = typeof WrappedComponent === 'string' ? undefined : mobx_react_1.observer(WrappedComponent);
    var Field = (function (_super) {
        ...
        Field.prototype.render = function () {
            ...
            if (WC) {
                return React.createElement(WC, __assign({}, this.props, { field: this.store }));
            }
            else {
