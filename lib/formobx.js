...
var formobxRootStore_1 = require("./formobxRootStore");
...
function wrapOnSubmit(store, callback) {
    return function (e) {
        ...
        Promise.resolve(callback(store.value))
            .catch(function (result) { return store.setAllErrors(result); })
...
function formobx(component, options) {
    return _a = (function (_super) {
            ...
            function Form(props) {
                ...
                _this.store = new formobxRootStore_1.FormobxRootStore(options);
