...
var getValues = (0, _mapValues2.default)(function (f) {
  return f.value;
});
var getErrors = (0, _mapValues2.default)(function (f) {
  return f.errors;
});
...
(function () {
  ...
  __REACT_HOT_LOADER__.register(getValues, 'getValues', 'src/store.js');

  __REACT_HOT_LOADER__.register(getErrors, 'getErrors', 'src/store.js');
